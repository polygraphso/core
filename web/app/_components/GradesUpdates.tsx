...
// Quiet down-page signup — one field, "notify me about new grades."
// Lives here as its own block because the matrix section it used to live
// inside (§04) is pulled until real grades exist.
      ...
      <div className="border hairline bg-parchment-50 p-6 md:p-10 grid md:grid-cols-12 gap-6 md:gap-10 items-center">
        <div className="md:col-span-7">
          <h2 className="font-serif text-2xl md:text-3xl leading-tight text-ink">
            Get notified when grades publish.
          </h2>
          <p className="mt-2 text-ink-muted">
            One email when grades for the servers you care about land. No drip
            campaign, no &ldquo;hey just checking in.&rdquo;
          </p>
        </div>
